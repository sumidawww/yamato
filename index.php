...
<html lang="ja">
  ...
  <div class="featurette logo_bg" style="margin-top:130px;">       
    <div class="top-word" style="float:right;">
      <p class="lead">
...
<table class="table radius table-borderless lead" style="padding:4px;margin-top:50px;margin-bottom:15px;">
  <tr>
    <td style="padding:0;margin:0">
        ...
        <tr style="margin:3px;">
          <td style="vertical-align:top;white-space:nowrap;margin-left:0;margin-right:0">
            日時
          </td>
...
（他にイースター、ペンテコステ、クリスマスの各主日にも行います）
    ...
    <td style="width:35%;">
      <img class="width400 pull-right" src="./img/church/worship_main.jpg">
    </td>
  </tr>
</table> 
      </div>
    ...
    <!-- Wrap the rest of the page in another container to center all the content. -->
      ...
      <!-- START THE FEATURETTES -->
        ...
        <h2 class="featurette-heading left-border" style="margin-top:50px;margin-bottom:15px;">大和キリスト教会の所在地</h2>
...
最寄駅：学園前駅（北口） 徒歩10分程度
          ...
          <tr>
            ...
            <td class="radius" style="width:50%">
                <img class="width400 pull-left" style="margin-right:70px;" src="./img/selected/selected30.jpg">
            </td>
          </tr>
        </table>
